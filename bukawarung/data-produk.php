                ...
                <table border="1" cellspacing="0" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="produk/<?php echo $row['product_image']?>" width="150px"></td>
                            <td><?php echo ($row['product_status'] == 0)? 'Tidak Aktif':'Aktif' ?></td>
                            <td>
                                <a href="edit-produk.php?id=<?php echo $row['product_id'] ?>">Edit</a> || <a href="hapus-kategori.php?idk=<?php echo $row['product_id'] ?>" onclick="return confirm('Realll?')">Hapus</a>
                            </td>
                        </tr>
                    <?php }} else { ?>
                        <tr>

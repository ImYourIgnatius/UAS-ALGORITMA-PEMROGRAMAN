                ...
                <table border="1" cellspacing="0" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit-kategori.php?id=<?php echo $row['category_id'] ?>">Edit</a> || <a href="hapus-kategori.php?idk=<?php echo $row['category_id'] ?>" onclick="return confirm('Realll?')">Hapus</a>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>
